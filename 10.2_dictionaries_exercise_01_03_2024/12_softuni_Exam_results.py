def process_submissions(submissions, bans, language, points, number_of_submissions):
...
while True:
    ...
    if len(tokens) == 3:
        ...
        points = int(points)
        process_submissions(submissions, bans, language, points, number_of_submissions)
